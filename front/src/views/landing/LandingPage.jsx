...
function LandingPage() {
    ...
    <div className=" w-dvw overflow-hidden">
      ...
      <div className="flex flex-col  justify-center mt-4">
        ...
        <div className="flex mb-4">
          <h2 className="secondaryTitle px-4 px-4 lg:px-8">What we´ll dive into: </h2>
        </div>
        ...
        <div className="flex-col md:columns-2 gap-4  mt-5 mb-5 px-4 lg:px-8 ">
          <div className="mb-4 md:mb-8 lg:pb-8">
            <img
              ...
              alt="Icon 1"
            />
            <div className="mt-[-35px] ml-[60px] md:mt-[-90px] ml-[60px] lg:mt-[-100px] md:ml-[100px] lg:ml-[100px] text-base lg:text-lg F-Family">
          ...
          <div className="mb-4 md:mb-8 lg:pb-8">
            <img
              ...
              alt="Icon 5"
            />
            <div className="mt-[-35px] ml-[60px] md:mt-[-90px] ml-[60px] lg:mt-[-100px] md:ml-[100px] lg:ml-[100px]  text-base lg:text-lg F-Family F-Family">
  ...
  <div className="flex flex-col md:flex-row mx-4 mb-4 gap-5">
    <div className="agnieszkaImage md:w-1/2">
      <img src={Agniezka} alt="Agnieszka" />
    </div>

    <div className="md:w-1/2 xl:px-[3%]">
      <p className="secondaryTitle mb-4 ml-0 F-Family">Meet our speaker</p>
      <p className="mb-4 secondaryText text-2xl xl:text-3xl font-semibold">AGNIESZKA FRONIA</p>
      <p className="text-base md:text-lg xl:text-xl mb-3 xl:leading-relaxed F-Family">
        Hi, I am Agnieszka and I am a certified women’s health expert with a passion for helping others.
      </p>
      <p className="text-base md:text-lg xl:text-xl mb-3 xl:leading-relaxed F-Family">
        For many years, I struggled with hormonal health issues such as acne, hair loss, weight gain, absence of periods, insomnia, and high levels of stress and anxiety. Feeling confused, tired, and often ignored by many doctors, I decided to take control of my health.
      </p>
      <p className="text-base md:text-lg xl:text-xl mb-3 xl:leading-relaxed F-Family">
        Since 2015, I’ve traveled across South America and India, exploring various methods to resolve my symptoms. Along the way, I became a certified yoga, meditation, and breath-work teacher.
      </p>
      <p className="text-base md:text-lg xl:text-xl mb-3 xl:leading-relaxed F-Family">
        Additionally, I earned an MSc in Psychological Medicine and Mental Health from London Metropolitan University, focusing on hormones, inflammation, and gut health.
      </p>
      <p className="text-base md:text-lg xl:text-xl mb-3 xl:leading-relaxed F-Family">
        My goal is to help you navigate your hormonal, physical, psychological, and emotional health with ease.
      </p>
      <p className="text-base md:text-lg xl:text-xl mb-3 xl:leading-relaxed F-Family">
        Join my upcoming webinar so we can get to know each other better and gain the knowledge you need to take control of your health.
      </p>
    </div>
  </div>
</div>
        ...
        <div className="">
          ...
          <div className="flex-col md:columns-2">
            <div className="m-4 md:mr-5  md:px-8 ">
              ...
              <h3 className="text-2xl  mb-4 tracking-widest font-bold F-Family">TO LIVE HER BEST LIFE!</h3>
            </div>
            ...
            <div className=" carrousel px-4 ">
              <Slider {...settings}>
                <div className="carrouselImg  md:mt-5  relative">
                  ...
                  <h1 className="F-Family absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-bold text-4xl lg:text-6xl z-10"C>SUPPORT</h1>
                </div>
                <div className="carrouselImg  md:mt-5 relative ">
                  <img src={LandingSlice2} alt="Slide 2" />
                  <h1 className="F-Family absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-bold text-4xl  lg:text-6xl z-10" >RESOURCES</h1>
                </div>
                <div className="carrouselImg  md:mt-5 relative ">
                  <img src={LandingSlice3} alt="Slide 3" />
                  <h1 className="F-Family absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-bold text-4xl lg:text-6xl z-10">AWARENESS</h1>
                </div>
              </Slider>
            </div>
          </div>
            ...
            <div className="film-strip flex animate-scroll">
              ...
              <div className="comment  relative p-4 mb-5">
                ...
                <p className="text-base  px-3 pt-0 mt-4 text-center leading-7 F-Family">
                  ...
                  influential world, so I believe more webinars like this are
                  needed more often.
                </p>
          ...
          <div className="absolute inset-y-40  md:inset-0  flex flex-col  md:flex-row">
            
           
            <div className="relative  flex-shrink-0 md:w-1/2 flex items-end justify-center ">
              <img
                className="absolute object-cover min-w-[342px] " 
                src={ImageFooterSin}
                alt="bottom image"
              />
            </div>
        
            <div className=" bottom-details md:w-1/2 flex flex-col justify-center items-center text-center md:text-left lg:mx-12 px-4 md:px-8 gap-6">
              <h3 className="text-xl lg:text-[41px]" >SIGN UP NOW</h3>
              <p className="F-Family text-lg xl:text-xl">WEBINAR DAY 10TH SEPTEMBER 2024</p>
              <h2 className="F-Family-2 text-3xl xl:text-[41px]">Boost Your Mood & Get Back Your Energy</h2>
              <Link to="/landing-form">
